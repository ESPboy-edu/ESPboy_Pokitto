...
namespace Images {
    ...
    const uint8_t * const SpaceTaxi_LandingGear[] PROGMEM = { 
        SpaceCabWithRamp_Right,
        SpaceCabWithRamp_Left,
    };

    const uint8_t * const SpaceTaxi[] PROGMEM = { 
        SpaceTaxi_facingRight,
        SpaceTaxi_facingLeft,
    };

    const uint8_t * const SpaceTaxi_OutOfFuel_1[] PROGMEM = { 
        SpaceTaxi_OutOfFuel_1R,
        SpaceTaxi_OutOfFuel_1L,
    };

    const uint8_t * const SpaceTaxi_OutOfFuel_2[] PROGMEM = { 
        SpaceTaxi_OutOfFuel_2R,
        SpaceTaxi_OutOfFuel_2L,
    };

    const uint8_t * const SpaceTaxi_OutOfFuel_3[] PROGMEM = { 
        SpaceTaxi_OutOfFuel_3R,
        SpaceTaxi_OutOfFuel_3L,
    };

    const uint8_t * const SpaceTaxi_OutOfFuel_4[] PROGMEM = { 
        SpaceTaxi_OutOfFuel_4R,
        SpaceTaxi_OutOfFuel_4L,
    };

    const uint8_t * const ThrusterLeft[] PROGMEM = { 
        ThrusterLeft_Frame0,
        ThrusterLeft_Frame1,
    };

    const uint8_t * const ThrusterRight[] PROGMEM = { 
