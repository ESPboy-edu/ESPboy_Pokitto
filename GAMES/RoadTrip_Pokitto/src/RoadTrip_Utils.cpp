...
//            if (mainThemeFile.openRO(sounds[themeToPlay])) {
                auto& music = Audio::play<0>(Music::music01);
                music.setLoop(true);
            }
...
/*
 ...
 switch ((uint8_t)soundEffect){
   case 0: &Audio::play<2>(Music::music20); break;
   case 1: &Audio::play<2>(Music::music21); break;
   case 2: &Audio::play<2>(Music::music22); break;
   case 3: &Audio::play<2>(Music::music23); break;
   case 4: &Audio::play<2>(Music::music24); break;
   case 5: &Audio::play<2>(Music::music25); break;
   case 6: &Audio::play<2>(Music::music26); break;
   case 7: &Audio::play<2>(Music::music27); break;
   case 8: &Audio::play<2>(Music::music28); break;
   case 9: &Audio::play<2>(Music::music29); break;
   case 10: &Audio::play<2>(Music::music30); break;
   case 11: &Audio::play<2>(Music::music31); break;
   case 12: &Audio::play<2>(Music::music32); break;
 }
}
  ...
  //  #ifdef SOUNDS
        ...
        switch (soundEffect) {
            ...
            case SoundEffects::Bump:
                Audio::play<1>(Sounds::sfx_Bump);        
                break;
            
            case SoundEffects::Passing:
                Audio::play<1>(Sounds::sfx_Passing);        
                break;
            
            case SoundEffects::ButtonPress:
                Audio::play<1>(Sounds::sfx_ButtonPress);        
                break;
