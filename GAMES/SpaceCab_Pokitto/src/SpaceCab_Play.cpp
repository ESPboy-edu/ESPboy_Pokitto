...
*/
      uint8_t dru=random(40, 80);
      if((Pokitto::Buttons::upBtn() || Pokitto::Buttons::downBtn() || Pokitto::Buttons::leftBtn() || Pokitto::Buttons::rightBtn()) || player.getYDelta()){
         noTone(D3);
         tone(D3, (10 - (player.getYDelta() * 5)), dru);
      }
      else{noTone(D3); tone(D3,-20,20);}
    #endif
