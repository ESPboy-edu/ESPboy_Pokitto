...
namespace Images {
    ...
    PROGMEM const uint8_t * const Bats[] = { 
        Bat_00,
        Bat_01,
    };

    PROGMEM const uint8_t * const Spiders[] = { 
        Spider_00_F0,
        Spider_00_F1,
        Spider_01_F0,
        Spider_01_F1,
    ...
    PROGMEM const uint8_t * const BigSpiders[] = { 
        Spider_16_00_F0,
        Spider_16_00_F1,
        Spider_16_01_F0,
        Spider_16_01_F1,
    ...
    PROGMEM const uint8_t * const Skeletons[] = { 
        Skeleton_Rising_F0,
        Skeleton_Rising_F1,
        Skeleton_Rising_F2,
    ...
    PROGMEM const uint8_t * const Necromancer[] = { 
    ...
    PROGMEM const uint8_t * const Hobgoblin[] = { 
        Hobgoblin_00_F0,
        Hobgoblin_00_F1,
        Hobgoblin_02_F0,
        Hobgoblin_02_F1,
    ...
    PROGMEM const uint8_t * const Cyclop[] = { 
        Cyclop_01_F0,
        Cyclop_01_F1,
        Cyclop_01_F0,
        Cyclop_01_F1,
    ...
    PROGMEM const uint8_t * const Beholder[] = { 
        Beholder_00_F0,
        Beholder_00_F1,
        Beholder_00_F0,
        Beholder_00_F1,
    ...
    PROGMEM const uint8_t * const Necromancer_Spell[] = { 
        Necromancer_Spell_00,
        Necromancer_Spell_01,
    };

    PROGMEM const uint8_t * const SpikeLHS[] = { 
        Spike_LHS_00,
        Spike_LHS_01,
        Spike_LHS_02,
        Spike_LHS_03,
    ...
    PROGMEM const uint8_t * const SpiderWeb[] = { 
        SpiderWeb_00,
        SpiderWeb_01,
        SpiderWeb_02,
        SpiderWeb_03,
    ...
    PROGMEM const uint8_t * const Snakes[] = { 
        Snake_00_F0,
        Snake_00_F1,
        Snake_02_F0,
        Snake_02_F1,
    ...
    PROGMEM const uint8_t * const Fires[] = { 
        Fire_00,
        Fire_01,
        Fire_02,
        Fire_03,
    ...
    PROGMEM const uint8_t * const Chests[] = { 
        Chest_00_F0,
        Chest_00_F1,
        Chest_02_F0,
        Chest_02_F1,
    ...
    PROGMEM const uint8_t * const Eyes[] = { 
        Eye_00_F0,
        Eye_00_F1,
        Eye_02_F0,
        Eye_02_F1,
